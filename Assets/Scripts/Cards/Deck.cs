...
*/
            ...
            Data.Left.Available = true; //= currentData.left == null ? true : Services.Data.CheckConditions (currentData.left.condi, time);
    ...
    */
            ...
            _currentCard.GetComponent<Card>().UpdateData(Data);
